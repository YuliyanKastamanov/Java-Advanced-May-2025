...
public class P06_WordCount {
    public static void main(String[] args) throws IOException {
        ...
        String pathWords = "src/L04_Streams_Files_And_Directories/resourses/words.txt";

        String pathTwo = "src/L04_Streams_Files_And_Directories/resourses/text.txt";
        ...
        PrintWriter writer = new PrintWriter("src/L04_Streams_Files_And_Directories/resourses/results.txt");
