package JavaAdvanced.Exam_Examples.hotel;

public class Main {
    public static void main(String[] args) {

        //Initialize the repository (JavaAdvanced.Exam_Examples.hotel)
        ...
        // The people in the JavaAdvanced.Exam_Examples.hotel Hilton are:
        // Person Mark: 11111, Age: 41, Hometown: Sofia
